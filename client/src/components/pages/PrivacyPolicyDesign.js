    ...
    render() {
        return (
            ...
            <div style={{float: 'center',  padding: 65, backgroundImage:`url(${BI})`, backgroundRepeat: 'no-repet', backgroundAttachment: 'fixed', backgroundSize: 'cover', backgroundSize: '100%'}}>
                ...
                <p style={{color: 'white', textAlign: 'justify', paddingTop: 10, fontSize:18, textShadow: '0 0 0.1em white'}}>Chatbot CONFIDENT, mejor conocido como CONFIDENT, con domicilio en calle Avenida Gral. Francisco J. Múgica S/N, colonia Ciudad Universitaria, ciudad Morelia, municipio o delegación Morelia, c.p. 58030, en la entidad de Michoacán, país México, es el responsable del uso y protección de sus datos personales, y al respecto le informamos lo siguiente:</p>
                ...
                <p style={{color: 'white', textAlign: 'justify', paddingLeft:50, paddingTop: 10, fontSize:18, textShadow: '0 0 0.1em white'}}>b) Domicilio: calle Avenida Gral. Francisco J. Múgica S/N, colonia Ciudad Universitaria, ciudad Morelia, municipio o delegación Morelia, c.p. 58030, en la entidad de Michoacán, país MÉXICO</p>
                <p style={{color: 'white', textAlign: 'justify', paddingLeft:50, paddingTop: 10, fontSize:18, textShadow: '0 0 0.1em white'}}>c) Correo electrónico: christian.erick.mf@gmail.com</p>
                ...
                <p style={{color: 'white', textAlign: 'right', paddingTop: 20, fontSize:14, textShadow: '0 0 0.1em white'}}>Última actualización: 20/08/2022</p>
